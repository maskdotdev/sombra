...
impl SombraDB {
    ...
    pub fn begin_transaction(&mut self) -> std::result::Result<SombraTransaction, Error> {
        ...
        db.enter_transaction(tx_id)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to enter transaction: {}", e)))?;
    ...
    #[napi]
    pub fn add_node(&mut self, labels: Vec<String>, properties: Option<HashMap<String, SombraPropertyValue>>) -> std::result::Result<f64, Error> {
        let mut db = self.inner.lock().unwrap();
    ...
    #[napi]
    pub fn add_edge(&mut self, source_node_id: f64, target_node_id: f64, label: String, properties: Option<HashMap<String, SombraPropertyValue>>) -> std::result::Result<f64, Error> {
        let mut db = self.inner.lock().unwrap();
    ...
    pub fn get_edge(&mut self, edge_id: f64) -> std::result::Result<SombraEdge, Error> {
        ...
        let edge = db.load_edge(edge_id as u64)
    ...
    pub fn get_outgoing_edges(&mut self, node_id: f64) -> std::result::Result<Vec<f64>, Error> {
        ...
        let node = db.get_node(node_id as u64)
        ...
        while edge_id != crate::model::NULL_EDGE_ID {
            ...
            let edge = db.load_edge(edge_id)
                .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to load edge: {}", e)))?;
    ...
    pub fn get_neighbors(&mut self, node_id: f64) -> std::result::Result<Vec<f64>, Error> {
        ...
        let neighbors = db.get_neighbors(node_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to get neighbors: {}", e)))?;
    ...
    pub fn delete_node(&mut self, node_id: f64) -> std::result::Result<(), Error> {
        ...
        db.delete_node(node_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to delete node: {}", e)))?;
    ...
    pub fn delete_edge(&mut self, edge_id: f64) -> std::result::Result<(), Error> {
        ...
        db.delete_edge(edge_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to delete edge: {}", e)))?;
    ...
    pub fn checkpoint(&mut self) -> std::result::Result<(), Error> {
        ...
        db.checkpoint()
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to checkpoint: {}", e)))?;
...
impl SombraTransaction {
    ...
    pub fn add_node(&mut self, labels: Vec<String>, properties: Option<HashMap<String, SombraPropertyValue>>) -> std::result::Result<f64, Error> {
        ...
        let node_id = db.add_node_internal(node)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to add node in transaction: {}", e)))?;
    ...
    pub fn add_edge(&mut self, source_node_id: f64, target_node_id: f64, label: String, properties: Option<HashMap<String, SombraPropertyValue>>) -> std::result::Result<f64, Error> {
        ...
        let edge_id = db.add_edge_internal(edge)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to add edge in transaction: {}", e)))?;
    ...
    pub fn get_edge(&mut self, edge_id: f64) -> std::result::Result<SombraEdge, Error> {
        ...
        let edge = db.load_edge(edge_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to get edge in transaction: {}", e)))?;
    ...
    pub fn get_outgoing_edges(&mut self, node_id: f64) -> std::result::Result<Vec<f64>, Error> {
        ...
        let node = db.get_node(node_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to get node in transaction: {}", e)))?;
        ...
        while edge_id != crate::model::NULL_EDGE_ID {
            edges.push(edge_id as f64);
            let edge = db.load_edge(edge_id)
                .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to load edge in transaction: {}", e)))?;
            edge_id = edge.next_outgoing_edge_id;
        }
    ...
    pub fn get_neighbors(&mut self, node_id: f64) -> std::result::Result<Vec<f64>, Error> {
        ...
        let neighbors = db.get_neighbors(node_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to get neighbors in transaction: {}", e)))?;
    ...
    pub fn delete_node(&mut self, node_id: f64) -> std::result::Result<(), Error> {
        ...
        db.delete_node_internal(node_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to delete node in transaction: {}", e)))?;
    ...
    pub fn delete_edge(&mut self, edge_id: f64) -> std::result::Result<(), Error> {
        ...
        db.delete_edge_internal(edge_id as u64)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to delete edge in transaction: {}", e)))?;
    ...
    pub fn commit(&mut self) -> std::result::Result<(), Error> {
        if self.committed {
            return Err(Error::new(Status::GenericFailure, "Transaction already committed or rolled back"));
        }
        ...
        db.write_header()
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to write header: {}", e)))?;
        ...
        db.commit_to_wal(self.tx_id, &all_dirty)
            .map_err(|e| Error::new(Status::GenericFailure, format!("Failed to commit to WAL: {}", e)))?;
...
impl TryFrom<SombraPropertyValue> for PropertyValue {
    ...
    fn try_from(js_value: SombraPropertyValue) -> std::result::Result<Self, Self::Error> {
        match js_value.r#type.as_str() {
            ...
            _ => Err(Error::new(Status::InvalidArg, format!("Unknown property type: {}", js_value.r#type))),
        }
    }
}
