...
//!
//! Defines core identifiers for nodes, edges, properties, labels, and pages,
//! along with error types and checksum utilities.
...
/// Unique identifier for a string value in the dictionary.
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, Hash, Debug)]
pub struct StrId(pub u32);

/// Unique identifier for a node label.
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, Hash, Debug)]
pub struct LabelId(pub u32);

/// Unique identifier for an edge type.
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, Hash, Debug)]
pub struct TypeId(pub u32);

/// Unique identifier for a property name.
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, Hash, Debug)]
...
/// Log sequence number for tracking transaction positions.
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd, Hash, Debug)]
pub struct Lsn(pub u64);

/// Reference to variable-length data stored across multiple pages.
#[derive(Copy, Clone, Eq, PartialEq, Hash, Debug)]
pub struct VRef {
    /// Page ID where data starts.
...
pub enum SombraError {
    ...
    /// Data corruption detected (structural or checksum failure).
    #[error("corruption: {0}")]
