...
fn print_stats_text(_: OutputFormat, report: &sombra_admin::StatsReport) {
    println!("Pager:");
    println!(
...
fn print_checkpoint_text(_: OutputFormat, report: &sombra_admin::CheckpointReport) {
    println!(
...
fn print_vacuum_text(_: OutputFormat, report: &sombra_admin::VacuumReport) {
    println!(
...
fn print_verify_text(_: OutputFormat, report: &sombra_admin::VerifyReport) {
    println!(
