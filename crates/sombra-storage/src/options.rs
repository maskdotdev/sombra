...
pub struct GraphOptions {
    ...
    pub metrics: Option<Arc<dyn crate::metrics::StorageMetrics>>,
}
...
impl GraphOptions {
    ...
    pub fn metrics(mut self, metrics: Arc<dyn crate::metrics::StorageMetrics>) -> Self {
