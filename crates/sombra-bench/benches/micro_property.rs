...
use sombra_index::{intersect_sorted, VecPostingStream};
use sombra_pager::{PageStore, Pager, PagerOptions};
use sombra_storage::{Graph, GraphOptions, NodeSpec, PropEntry, PropValue, PropValueOwned};
use sombra_types::{LabelId, PropId};
        ...
        let mut rng = ChaCha8Rng::seed_from_u64(0xC0FFEE);
        {
            ...
            graph
                .create_property_index(
                    &mut write,
                    sombra_index::IndexDef {
                        label,
                        prop,
                        kind: sombra_index::IndexKind::Chunked,
                        ty: sombra_index::TypeTag::Int,
                    },
                )
                .expect("index");
