...
- [ ] **Planner unit tests**: add cases where `match("User").where_prop("a","name",Eq,"foo")` yields a physical `PropIndexScan`, plus range predicates and “no index available” fallbacks.
