  ...
  addEdge(sourceNodeId, targetNodeId, edgeTypeOrLabel, properties = {}) {
    if (properties && Object.keys(properties).length > 0) {
      ...
      if (isTypedPropertyValue(firstValue)) {
        return this._db.addEdge(sourceNodeId, targetNodeId, edgeTypeOrLabel, properties);
      }
      const sombraProps = convertPropertiesToSombra(properties);
      return this._db.addEdge(sourceNodeId, targetNodeId, edgeTypeOrLabel, sombraProps);
    }
    return this._db.addEdge(sourceNodeId, targetNodeId, edgeTypeOrLabel, properties);
  }
