...
fn benchmark_btree_insert(count: usize) -> u128 {
    ...
    for i in 0..count {
        index.insert(i as u64, RecordPointer { page_id: i as u32, slot_index: 0, byte_offset: 0 });
    }
...
fn main() {
    ...
    println!("{:<10} {:<15} {:<15} {:<15}", "Size", "BTree (µs)", "HashMap (µs)", "Ratio");
    println!("{:-<55}", "");
    for &size in &sizes {
        ...
        println!("{:<10} {:<15} {:<15} {:<15.2}x", size, btree_time, hashmap_time, ratio);
    }
