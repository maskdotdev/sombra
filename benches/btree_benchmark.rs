...
fn main() {
    ...
    println!("Per lookup: {} ns", (time * 1000) / sample_ids.len() as u128);
    ...
    println!("{:<10} {:<15} {:<15} {:<15}", "Size", "BTree (µs)", "HashMap (µs)", "Speedup");
    println!("{:-<55}", "");
    ...
    for &size in &[1_000, 5_000, 10_000] {
        ...
        println!("{:<10} {:<15} {:<15} {:<15.2}x", size, btree_time, hashmap_time, speedup);
    }
